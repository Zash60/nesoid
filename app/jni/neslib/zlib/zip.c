...
typedef struct
{
    ...
    uLong pos_local_header;     /* offset of local header of the file
                                     currenty writing */
    char* central_header;       /* central header data for current file */
    uLong size_centralheader;   /* size of central header for cur file */
    uLong flag;                 /* flag of file currently writing */
...
typedef struct
{
    ...
    uLong begin_pos;            /* position of beginning of the zipfile */
...
#    ifndef NO_ADDFILEINEXISTINGZIP
    ...
    if (append == APPEND_STATUS_ADDINZIP)
    {
        ...
        /* offset of the start of the central directory with respect to the 
    ...
    if (globalcomment)
    {
      // FIX: Cast away const to assign to the output parameter
      *(zipcharpc*)globalcomment = ziinit.globalcomment;
    }
#    endif /* !NO_ADDFILEINEXISTINGZIP*/
...
extern int ZEXPORT zipClose(zipFile file, const char* global_comment)
{
    ...
    if (err==ZIP_OK) /* offset of the start of the central directory with respect to the
                            starting disk number */
